...
try {
  ...
  const logger32 = new Logger(version11);
  WS = function() {
...
var UrlJsonRpcProvider = class _UrlJsonRpcProvider extends StaticJsonRpcProvider {
  constructor(network, apiKey) {
    logger20.checkAbstract(new.target, _UrlJsonRpcProvider);
...
function getHost(name) {
  ...
  return logger22.throwArgumentError("unsupported network", "name", name);
}
...
var logger24 = new Logger(version11);
...
var EtherscanProvider = class extends BaseProvider {
  ...
  getBaseUrl() {
    ...
    return logger24.throwArgumentError("unsupported network", "network", this.network.name);
  }
...
var logger25 = new Logger(version15);
function getGlobal() {
...
var logger26 = new Logger(version11);
function now() {
  return (/* @__PURE__ */ new Date()).getTime();
}
...
var logger27 = new Logger(version11);
...
var logger28 = new Logger(version11);
...
var logger29 = new Logger(version11);
...
var logger30 = new Logger(version11);
var _nextId = 1;
...
// node_modules/@ethersproject/providers/lib.esm/index.js
var logger31 = new Logger(version11);
...
//# sourceMappingURL=chunk-DHFEHKU5.js.map
